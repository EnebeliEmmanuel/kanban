              ...
              {list.cards.map((card) => {
                return (
                  <Draggable
                    key={card.id}
                    onStop={(e,) => {
                      // Add your logic for handling the draggable card's position here
                  ...
                  >
                    <div style={styles.cardContainer}>
                      <input
                        ...
                        value={card.title}
                        onChange={(e) => {
                          // Add your logic for handling the card title change here
                          let temp_boards = [...board]
            for (let i = 0; i < temp_boards.length; i++) {
             ...
             setBoard(temp_boards)
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          // Add your logic for handling the card description change here
                          let temp_boards = [...board]
            for (let i = 0; i < temp_boards.length; i++) {
              for (let j = 0; j < temp_boards[i].cards.length; j++) {
               if (temp_boards[i].cards[j].id === card.id) {
